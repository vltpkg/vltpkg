#!/usr/bin/env node
/**
 * Generates src/cli-sdk/src/commands-map.ts — static command dispatch.
 *
 * `import()` below module top level is silently dropped by the compiler
 * and a template-literal specifier fails `check --check-deps` outright, so
