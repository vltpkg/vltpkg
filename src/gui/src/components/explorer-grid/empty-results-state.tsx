...
const MiniQuery = ({ className = '' }: { className?: string }) => {
  return (
    <div
      className={`flex h-[70px] w-[300px] flex-col rounded-sm border-[1px] border-neutral-200 bg-muted dark:border-neutral-800 dark:bg-black ${className}`}>
      <div className="flex items-center justify-between border-b-[1px] border-neutral-200 p-2 dark:border-neutral-800">
        <div className="h-[18px] w-[80px] rounded-sm border-[1px] border-neutral-300 bg-neutral-200 dark:border-neutral-800 dark:bg-neutral-950" />
        <div className="h-[16px] w-[60px] rounded-sm border-[1px] border-neutral-300 bg-neutral-200 dark:border-neutral-800 dark:bg-neutral-950" />
      </div>
      <div className="flex h-full w-full items-center justify-between p-2">
        <div className="h-[12px] w-[125px] rounded-sm border-[1px] border-neutral-300 bg-neutral-200 dark:border-neutral-800 dark:bg-neutral-950" />
