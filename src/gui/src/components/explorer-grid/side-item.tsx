  ...
  return (
    <div className="group relative z-10" ref={divRef}>
      {item.stacked ?
        <>
          {item.size > 2 ?
            <div className="absolute border top-2 left-2 w-[96%] h-full bg-card rounded-lg group-hover:border-indigo-600 group-hover:bg-indigo-100 dark:group-hover:bg-gradient-to-b dark:group-hoverfrom-indigo-950 dark:group-hoverto-zinc-950 dark:group-hover:border-indigo-300"></div>
          : ''}
          <div className="absolute border top-1 left-1 w-[98%] h-full bg-card rounded-lg group-hover:border-indigo-600 group-hover:bg-indigo-100 dark:group-hover:bg-gradient-to-b dark:group-hover:from-indigo-950 dark:group-hover:to-zinc-950 dark:group-hover:border-indigo-300"></div>
        </>
      : ''}
      <Card
        className={`transition-colors relative my-4 ${highlight ? 'border-primary' : ''} ${item.to ? 'cursor-pointer' : ''} group-hover:border-indigo-600 group-hover:bg-indigo-100  dark:group-hover:bg-gradient-to-b dark:group-hover:from-indigo-950 dark:group-hover:to-zinc-950 dark:group-hover:border-indigo-300`}
        onClick={onClick}>
