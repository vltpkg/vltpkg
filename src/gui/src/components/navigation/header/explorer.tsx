      ...
      <QueryBar
        ...
        endContent={
          <div className="relative mr-3 hidden items-center gap-1 md:flex">
            ...
            <div className="absolute inset-0 -bottom-2 -right-3 -top-2 z-[-2] rounded-br-full rounded-tr-full border-y border-r border-input bg-gradient-to-r from-white/20 via-white/50 to-white backdrop-blur-sm dark:from-neutral-900/20 dark:via-neutral-900/50 dark:to-neutral-900" />
          </div>
        }
      />
    </div>
