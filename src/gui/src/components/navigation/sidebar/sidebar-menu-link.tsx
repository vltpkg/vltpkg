            ...
            <CollapsibleTrigger
              ...
              <MenuItemButton
                ...
                <Comp
                  ...
                  role="button"
                  className="group/sidebar-button text-muted-foreground duration-250 w-full cursor-default transition-colors transition-opacity hover:bg-transparent data-[state=open]:hover:bg-transparent">
                  {item.icon && (
