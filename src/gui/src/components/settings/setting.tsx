...
export interface SettingFieldProps {
  name: string
  description: string
  field: DropdownFieldProps | ToggleFieldProps | InputFieldProps
  className?: string
}
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="duration-250 group inline-flex h-10 w-full min-w-36 cursor-default items-center justify-between gap-4 overflow-hidden truncate rounded-lg border-[1px] border-border px-2 py-1 text-sm transition-colors hover:border-neutral-200 hover:bg-neutral-100 dark:bg-neutral-950 dark:hover:border-neutral-800 dark:hover:bg-neutral-900">
