...
const dataBadgeVariants = tv({
  slots: {
    wrapperSlot: 'group font-sans h-[30px]',
  ...
  variants: {
    variant: {
      default: {
        wrapperSlot:
          'relative z-[1] w-fit flex cursor-default items-center justify-center gap-1.5 rounded-xl border-[1px] border-neutral-200 bg-neutral-100 px-2 py-1 text-[0.75rem] font-medium text-muted-foreground dark:border-[#313131] dark:bg-neutral-800',
        valueSlot:
      ...
      mono: {
        wrapperSlot:
          'font-courier relative z-[1] w-fit flex cursor-default items-center justify-center gap-1.5 rounded-xl border-[1px] border-neutral-200 bg-neutral-100 px-2 py-1 text-[0.75rem] font-medium text-muted-foreground dark:border-[#313131] dark:bg-neutral-800',
      },
      count: {
        wrapperSlot:
