  ...
  'inline-flex items-center justify-center',
  {
    variants: {
      variant: {
        ...
        outline:
          'px-3 py-1.5 text-sm font-medium ring-offset-background transition-all data-[state=active]:border-b-[1px] data-[state=active]:border-foreground border-border data-[state=active]:text-foreground text-muted-foreground',
      },
    },
    defaultVariants: {
      variant: 'default',
