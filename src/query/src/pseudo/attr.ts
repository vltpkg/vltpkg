...
import {ParserState, PostcssNode, asAttributeNode, asPostcssNodeWithChildren, asTagNode} from "../types.js"
 ...
 */
export const parseInternals = (nodes: PostcssNode[]): AttrInternals => {
