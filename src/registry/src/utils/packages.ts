 ...
 * @param {Buffer} _tarballBuffer - The tarball as a Buffer
 ...
 */
export function slimManifest(manifest: unknown, context?: SlimManifestContext): ParsedManifest {
  ...
  try {
    ...
    if (parsed.description !== undefined) slimmed.description = parsed.description
    if (parsed.keywords !== undefined) slimmed.keywords = parsed.keywords
    if (parsed.homepage !== undefined) slimmed.homepage = parsed.homepage
    ...
    if (parsed.contributors !== undefined) slimmed.contributors = parsed.contributors
    ...
    if (parsed.directories !== undefined) slimmed.directories = parsed.directories
    if (parsed.repository !== undefined) slimmed.repository = parsed.repository
    if (parsed.scripts !== undefined) slimmed.scripts = parsed.scripts
    if (parsed.dependencies !== undefined) slimmed.dependencies = parsed.dependencies
    if (parsed.devDependencies !== undefined) slimmed.devDependencies = parsed.devDependencies
    if (parsed.peerDependencies !== undefined) slimmed.peerDependencies = parsed.peerDependencies
    if (parsed.optionalDependencies !== undefined) slimmed.optionalDependencies = parsed.optionalDependencies
    if (parsed.bundledDependencies !== undefined) slimmed.bundledDependencies = parsed.bundledDependencies
    if (parsed.peerDependenciesMeta !== undefined) slimmed.peerDependenciesMeta = parsed.peerDependenciesMeta
    ...
    // Handle dist object specially
    if (parsed.dist !== undefined) {
      slimmed.dist = {
        ...parsed.dist,
 ...
 * @param {string} originalUrl - The original tarball URL
 * @param {string} packageName - The package name
 * @param {string} version - The package version
...
function rewriteTarballUrlIfNeeded(
  ...
  try {
    ...
    // Rewrite to our local registry format
 ...
 * @param {Buffer} _tarballBuffer - The tarball buffer to validate
 * @returns {boolean} True if valid tarball
 */
export function validateTarball(_tarballBuffer: Buffer): boolean {
