...
vi.mock('../src/utils/packages.js', () => ({
  ...
  createVersion: ({ manifest }) => manifest,
}))
...
describe('Packument Response Format', () => {
  ...
  const setupTest = () => {
    ...
    const mockVersions = [
      {
        ...
        manifest: JSON.stringify({
          ...
          dist: {
            ...
            tarball:
              'https://registry.example.com/local-package/-/local-package-1.0.0.tgz',
          },
        }),
      ...
      },
      {
        ...
        manifest: JSON.stringify({
          ...
          dist: {
            ...
            tarball:
              'https://registry.example.com/local-package/-/local-package-1.1.0-beta.1.tgz',
          },
        }),
    ...
    const mockUpstreamData = {
      ...
      maintainers: [
        { name: 'upstream-user', email: 'user@example.com' },
      ],
      ...
      versions: {
        '2.0.0': {
          ...
          dist: {
            ...
            integrity: 'sha512-abcdefghijklmnopqrstuvwxyz0123456789',
            tarball:
              'https://registry.npmjs.org/proxied-package/-/proxied-package-2.0.0.tgz',
          },
        },
        '2.1.0-rc.1': {
          name: 'proxied-package',
          ...
          dist: {
            ...
            integrity: 'sha512-zyxwvutsrqponmlkjihgfedcba0987654321',
            tarball:
              'https://registry.npmjs.org/proxied-package/-/proxied-package-2.1.0-rc.1.tgz',
          },
        },
      },
      time: {
  ...
  it('should return consistent packument for proxied packages with only required fields', async () => {
    ...
    mockContext.req.param = vi.fn(paramName => {
      if (paramName === 'pkg') {
    ...
    mockContext.db.upsertPackage = vi.fn(async (_name, tags) => {
      capturedTags = tags
      return true
    })
