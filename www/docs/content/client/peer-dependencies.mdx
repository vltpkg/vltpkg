...
Use `vlt query` with the
[Dependency Selector Syntax](/client/selectors) to inspect peer
...
- [Query Selectors](/client/selectors)
- [Graph Modifiers](/client/graph-modifiers)
