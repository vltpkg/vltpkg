...
[combinators](/client/selectors/combinators) and
...
[`:attr()` pseudo-class](/client/selectors/pseudo-classes/attr):
...
- [ID Selectors](/client/selectors/id-selectors) — shorthand for
  `[name=value]`
