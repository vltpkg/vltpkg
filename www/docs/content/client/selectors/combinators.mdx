...
[attribute selectors](/client/selectors/attribute-selectors) and
[pseudo-classes](/client/selectors/pseudo-classes):
...
- [Pseudo-state Selectors](/client/selectors/pseudo-states) — `:root`,
  `:project`, `:workspace`
- [`:has()` pseudo-class](/client/selectors/pseudo-classes/has) —
  filter by descendant relationships
