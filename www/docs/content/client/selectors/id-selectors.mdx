...
<Aside type="caution">
  ...
  packages (e.g. `@vltpkg/cli`), use [attribute
  selectors](/client/selectors/attribute-selectors) instead:
  `[name=@vltpkg/cli]`.
</Aside>
...
- [Attribute Selectors](/client/selectors/attribute-selectors) — full
