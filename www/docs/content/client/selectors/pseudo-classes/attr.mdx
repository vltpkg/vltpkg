...
[attribute selectors](/client/selectors/attribute-selectors) match
...
- [Attribute Selectors](/client/selectors/attribute-selectors) —
  top-level property matching
- [`:semver()`](/client/selectors/pseudo-classes/semver) — compare
