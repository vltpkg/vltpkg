...
[pseudo-classes](/client/selectors/pseudo-classes), they don't take
arguments.
...
Commonly used with [combinators](/client/selectors/combinators) to
...
metadata. See [Security Insights](/client/selectors/security-insights)
...
- [Pseudo-class Selectors](/client/selectors/pseudo-classes) —
  functional selectors with arguments
- [Combinators](/client/selectors/combinators) — traverse the graph
- [Security Insights](/client/selectors/security-insights) — security
  pseudo-selectors
