...
| Flag            | Description                                                                                                                                                                                             |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--save-config` | Save registry and git host options given on the command line or via env to the project `vlt.json` (user one with `--config=user`), see [Registries](/cli/registries#saving-registries-given-to-install) |
