...
| Flag            | Description                                                                                                                                                 |
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--save-config` | Save registry and git host options given on the command line or via env to `vlt.json`, see [Registries](/cli/registries#saving-registries-given-to-install) |
