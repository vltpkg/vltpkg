...
[Registries](/cli/registries#saving-registries-given-to-install).
...
- auto: Default. On Linux, hardlink from the global store, copying any
  ...
  keep unpacking until they get a linker of their own.
...
[Global store](/cli/commands/cache#global-store).
