...
- `:prerelease` Matches packages that have prerelease versions
  (e.g., `1.2.3-alpha.1`, `2.0.0-rc.2`). This can be useful for
  selecting prerelease packages or excluding them with
  `:not(:prerelease)`.
