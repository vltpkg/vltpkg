...
- ⚡ **One-command deployment** - Deploy to Cloudflare Workers with
  `vsr deploy`
- 🌍 **Multi-environment support** - Separate dev, staging, and
  production environments
- 🔧 **Environment-specific configuration** - Customize settings per
  environment
- 👀 **Dry-run preview** - See what would be deployed before making
  changes
- 📊 **Built-in monitoring** - Sentry integration for error tracking
  and performance monitoring
- 🔄 **Background processing** - Queue-based cache refresh for optimal
  performance
...
[Getting Started guide](/registry/getting-started) for local
development, [Deployment guide](/registry/deployment) for production
deployment, or [Configuration](/registry/configuring) to set up your
package manager.
